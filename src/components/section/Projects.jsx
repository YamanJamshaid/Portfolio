                ...
                <div className="max-w-5xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="p-6 rounded-xl border border-white/10 hover:translate-y-1 hover:border-cyan-500/30 hover:shadow-[0_2px_8px_rgba(20, 255, 200, 0.2)] transition">
                            <img src="/images/Aspproject.jpg" alt="Project 1" className="w-full h-48 object-cover rounded-lg mb-4" />
                        ...
                        <div className="p-6 rounded-xl border border-white/10 hover:translate-y-1 hover:border-cyan-500/30 hover:shadow-[0_2px_8px_rgba(20, 255, 200, 0.2)] transition">
                            <img src="/images/TJsolution.jpg" alt="Project 2" className="w-full h-48 object-cover rounded-lg mb-4" />
                        ...
                        <div className="p-6 rounded-xl border border-white/10 hover:translate-y-1 hover:border-cyan-500/30 hover:shadow-[0_2px_8px_rgba(20, 255, 200, 0.2)] transition">
                            <img src="/images/myportfolio.jpg" alt="Project 3" className="w-full h-48 object-cover rounded-lg mb-4" />
                        ...
                        <div className="p-6 rounded-xl border border-white/10 hover:translate-y-1 hover:border-cyan-500/30 hover:shadow-[0_2px_8px_rgba(20, 255, 200, 0.2)] transition">
                            <img src="/images/graocoffee.jpg" alt="Project 3" className="w-full h-48 object-cover rounded-lg mb-4" />
                        ...
                        <div className="p-6 rounded-xl border border-white/10 hover:translate-y-1 hover:border-cyan-500/30 hover:shadow-[0_2px_8px_rgba(20, 255, 200, 0.2)] transition">
                            <img src="/images/Thegemstore.jpg" alt="Project 3" className="w-full h-48 object-cover rounded-lg mb-4" />
